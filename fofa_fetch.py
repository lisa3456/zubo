...
CHANNEL_CATEGORIES = {
    ...
    "数字": [
        ...
        "华数热播剧场", "华数碟战剧场", "华数军旅剧场", "华数城市剧场", "华数古装剧场", "华数魅力时尚",
...
CHANNEL_MAPPING = {
    ...
    "中国交通": ["中国交通频道"],
    "中国天气": ["中国天气频道"],
    "华数热播剧场": ["华数低于4K", "华数4K电影", "华数爱上4K"],
    "华数谍战剧场": ["华数低于4K", "华数4K电影", "华数爱上4K"],
    "华数军旅剧场": ["华数低于4K", "华数4K电影", "华数爱上4K"],
    "华数古装剧场": ["华数低于4K", "华数4K电影", "华数爱上4K"],
    "华数城市剧场": ["华数低于4K", "华数4K电影", "华数爱上4K"],   
    "华数魅力时尚": ["华数低于4K", "华数4K电影", "华数爱上4K"],
